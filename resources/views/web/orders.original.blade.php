...
@section('content')
    ...
    <section class="pedidos">
                ...
                <div class="dentro-caixa">
                    <div class="row-pedidos between-pedidos">
                        ...
                        <div class="info-pedido">
                            ...
                            <p>Quantidade final: <span class="texto-roxo">{{ (int)($retornoApi[$ultimoPedido->id]['inicial'] ?? 0) + (int)$ultimoPedido->quantity }}</span></p>
        ...
        <div class="caixa-pedido-table">
			...
			<td>{{ (int)($retornoApi[$pedido->id]['inicial'] ?? 0) + (int)$pedido->quantity }}</td>
