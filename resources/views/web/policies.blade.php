    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mauto">
                ...
                <h3>Introdução</h3>
                <p>Esta Política de Privacidade tem como objetivo esclarecer as práticas de coleta, uso e armazenamento de informações pessoais dos usuários que utilizam os serviços da SEGUIR PLAY, bem como o uso de tecnologias como cookies.</p>
                ...
                <ul class="ul-politicas">
                    <li>Contrato: Para a execução de contrato firmado entre você e a SEGUIR PLAY.</li>
                    <li>Obrigações Legais: Para cumprimento de exigências legais e regulatórias.</li>
                    <li>Interesses Legítimos: Para desenvolvimento e marketing de nossos produtos e serviços, incluindo a personalização de publicidade.</li>
                    <li>Consentimento: Conforme exigido pela Lei Geral de Proteção de Dados (LGPD).</li>
                </ul>
                ...
                <p>A SEGUIR PLAY opera sob as leis brasileiras e mantém todos os dados em conformidade com as normas vigentes. Seus dados não são compartilhados com terceiros, exceto quando necessário para fornecimento de nossos serviços, como processamento de pagamentos, ou **quando houver seu consentimento para fins de publicidade personalizada, conforme detalhado nesta política.**</p>
                ...
                <ul class="ul-politicas">
                    ...
                    <li>Uso exclusivo da SEGUIR PLAY, vedado seu acesso por terceiros, e desde que anonimizados os dados</li>
                </ul>
                ...
                <ul class="ul-politicas">
                    <li>Cookies Funcionais: Estes cookies permitem que o sistema recupere preferências do usuário, como idioma, região ou outras configurações personalizadas, proporcionando uma experiência adaptada às necessidades do cliente.</li>
                    <li>Cookies Analíticos/Desempenho: Coletam informações sobre como os visitantes usam o site (ex: páginas mais visitadas), ajudando a melhorar o desempenho do site.</li>
                    <li>Cookies de Publicidade/Segmentação: Usados para exibir anúncios mais relevantes para você, com base em seus interesses. **Esses cookies podem ser definidos por nós ou por terceiros (como o Google Ads) para exibir publicidade em outros sites.**</li>
                </ul>
                ...
                <ul class="ul-politicas">
                    ...
                    <li>Manter itens adicionados ao carrinho de compras durante a navegação por um período de 2 horas (DUAS HORAS) "SOMENTE".</li>
                    <li>Coleta de dados para otimização e personalização de campanhas publicitárias através de plataformas como o Google Ads.</li>
                    <li>Análise do comportamento do usuário no site para melhoria dos serviços e conteúdo.</li>
                </ul>
                <p>Gerenciamento de Cookies</p>
                <p>O gerenciamento de cookies neste contexto é restrito à funcionalidade de salvamento de itens no carrinho de compras durante 2 horas (DUAS HORAS) "SOMENTE" e ao uso para fins de publicidade personalizada e análise, conforme descrito. Não há uso adicional ou secundário dos cookies além deste propósito sem o seu consentimento explícito.</p>
                <p>Você pode controlar e gerenciar seus cookies através das configurações do seu navegador. A maioria dos navegadores permite que você bloqueie cookies, exclua cookies existentes ou receba um aviso antes que um cookie seja armazenado. No entanto, lembre-se que ao desabilitar certos cookies, algumas funcionalidades do site podem não operar corretamente.</p>
                <p>Disposições Finais</p>
                <p>Os cookies implementados têm como finalidade o suporte ao salvamento de itens no carrinho de compras, garantindo a persistência dessas informações durante a sessão do usuário, **bem como a coleta de dados anonimizados ou pseudonimizados para aprimorar a experiência do usuário e otimizar campanhas de publicidade.</p>
                
                <h3>Alteração desta Política de Privacidade</h3>
                <p>A versão atual desta Política de Privacidade foi formulada e atualizada pela última vez em 28 de junho de 2025.</p>
                ...
                <p>Qualquer modificação nesta Política entrará em vigor imediatamente após sua publicação em nosso site. Sempre informaremos a você sobre qualquer alteração substancial nesta Política.</p>
