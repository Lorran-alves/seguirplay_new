                    ...
                    <div class="cart-item mb-3" id="item{{ $item['id'] }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center" style="background-color: #f1eeee; padding: 10px; border-radius:5px;">
                            ...
                            <div>
                                <!-- Botão de expandir -->
                                <!-- Botão de expandir -->
                                <button class="button-carrinho-customizado toggle-details" data-target="itemDetails{{ $index }}">
                                    <i class="fas fa-eye"></i>
                                </button>

                                <!-- Formulário de remoção -->
                                <form action="{{ route('dashboard.gestaoPedidoManual.removeFromCart', ':id') }}" method="POST" class="d-inline" id="formRemove{{ $item['id'] }}">
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="item-details" id="itemDetails{{ $index }}" style="display: none">
