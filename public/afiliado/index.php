...
<html lang="en" class="scroll-smooth">
  <head>
    ...
    <title>
      Seguir Play - Progama de Afiliado
    </title>
    <link
      rel="shortcut icon"
      ...
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="http://afiliado.seguirplay.com.br" class="navbar-logo block w-full py-5">
              <img
            ...
            <div>
              ...
              >
                <ul class="blcok lg:flex 2xl:ml-20">
                  ...
                  <li class="group relative">
                    <a
                      href="https://seguirplay.com/contato"
                      class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10"
                    >
                      Contato
                    </a>
                  ...
                  <li class="group relative">
                    <a
                      href="https://blog.seguirplay.com/"
                      class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10"
                    >
                      Blog
                    </a>
        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              >
                Participe do progama de afiliado Seguir Play, compratilhe suas recomendações e gere receita.
              </p>
              <ul
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
              ...
              <p class="text-base text-body-color dark:text-dark-6">
                Afiliados, confira outras vantagens de se cadastrar.
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="wow fadeInUp group mb-12" data-wow-delay=".15s">
              ...
              >
                <span
                  class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"
                ></span>
                <svg width="37px" height="37px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none"><path fill="" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.948 9.95 14.998 8v6.587c0 .89-1.077 1.337-1.707.707L11.996 14c-.5-.5-1.701-.8-2.502 0-.8.8-.5 2 0 2.5l3.603 4.4A3 3 0 0 0 15.42 22H18a1 1 0 0 0 1-1v-6.1a7 7 0 0 0-2.052-4.95z"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 2h2a2 2 0 0 1 2 2v2m-4-4c0 1.333.8 4 4 4m-4-4H9m6 4v6M5 12v2a2 2 0 0 0 2 2h2c0-1.333-.8-4-4-4zm0 0V6m4-4H7a2 2 0 0 0-2 2v2m4-4c0 1.333-.8 4-4 4"/><circle cx="10" cy="9" r="1" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" transform="rotate(90 10 9)"/></svg>
              </div>
              <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                Ganhe
              </h4>
              <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                Receba dinheiro depois que as pessoas comprarem no seu link.
              </p>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
          ...
          <div class="-mx-4 flex flex-wrap items-stretch">
            <div class="w-full px-4">
              <div class="mx-auto max-w-[570px] text-center">
                ...
                >
                  A cada venda realizada por meio do seu site ou link, você ganha comissão de acordo com a sua faixa de venda.
                </p>
                <a
                  href="signup.php"
          ...
          <div class="w-full px-4 lg:w-1/2">
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                ...
                <p class="text-base text-body-color dark:text-dark-6">
                  Preencha o formulário com seus dados. Após receber o e-mail de confirmação, ative seu perfil para começar a gerar seu link.
                </p>
              </div>
            </div>
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  O que é ser afiliado do Seguir Play?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Afiliados Seguir Play são criadores de conteúdo que buscam diversificar a forma de monetização ou ganha uma renda extra de suas redes sociais.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  O que faz um afiliado Seguir Play? 
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Você divulga o seu link de afiliado em sites ou redes sociais e recebe uma porcentagem sobre as vendas qualificadas geradas.
                </p>
              </div>
            </div>
            <div class="mb-12 flex lg:mb-[70px]">
              ...
              <div class="w-full">
                <h3
                  class="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Quais os requisitos exigidos pelo Programa?
                </h3>
                <p class="text-base text-body-color dark:text-dark-6">
                  Você deve ter +18 e perfis de redes sociais públicas.
                </p>
              </div>
            </div>
          </div>
